...
#         from rides.utils import find_nearest_driver 
#         nearest_driver = find_nearest_driver(self.pickup_latitude, self.pickup_longitude)
#         if nearest_driver:
...
#         self.cancellation_fee = round(self.fare * 0.05, 2)  
